...
Thanks for your interest in contributing to OnboardJS Skills! This guide will help you add new skills or improve existing ones.

## Requesting a Skill

You can also suggest new skills by [opening a skill request](https://github.com/OnboardJS/onboardjs-skills/issues/new?template=skill-request.yml).
...
- **Directory name**: lowercase, hyphens only (e.g., `onboardjs-vue`)
